...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div id="dashboard-title">
            <h1 class="h3 fw-bold mb-0">Strands Management</h1>
             <p class="text-muted small">Manage and organize academic programs for the registrar.</p>
        </div>
        

        <button class="btn btn-primary btn-sm" id="addStrand">
            <i class="bi bi-plus-lg"></i> Add Strand
        </button>
...
<div class="modal fade" id="addStrandModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content shadow-sm">
            ...
            <div class="modal-body">
                ...
                <form class="row g-3" id="strandForm" action="<?php echo BASE_URL ?>/strand/store" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            name="strand_code"
                            id="strand_code"
                            placeholder="e.g. HUMSS, GAS">

                        <div class="invalid-feedback" id="error-strand_code"></div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="invalid-feedback" id="error-strand_name"></div>
                    </div>
...
<script src="<?php echo BASE_URL ?>/js/strand.js"></script>
