  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    */
    ...
    submitConcern.addEventListener('click',function(){

       let submitConcernModal = new bootstrap.Modal(document.getElementById('submitConcernModal'));
        submitConcernModal.show();
    });


    // submit button connect to form

    document.getElementById('addConcernSubmit').addEventListener('click', function() {

    document.getElementById('addConcertSubmitForm').requestSubmit();
    ...
    resetForm('addConcertSubmitForm');
   ...
   document.getElementById('addConcertSubmitForm').addEventListener('submit', function(e) {
    e.preventDefault(); 
    ...
    .then(data => {
        ...
        if (data.status === 'error') {
            ...
            const submitConcernModal = bootstrap.Modal.getInstance(document.getElementById('submitConcernModal'));
            submitConcernModal.hide();
    ...
    */
    ...
    fetch(`${BASE_URL}/concern/all?order=${order}&limit=${limit}&page=${page}&search=${encodeURIComponent(search)}`)
        .then(response => response.json())
        .then(result => {
            ...
            result.data.forEach((report)=> {
                tbody.innerHTML += `
                    <tr class="activity-row">
                     ...
                     <td><input type="checkbox" class="activity-checkbox" value="${report.issue_id}"></td>
                       ...
                       <td>
                        <button class="btn btn-primary btn-sm approved" data-id="${report.issue_id}">
                            Resolve
                        </button>
                    </td>
