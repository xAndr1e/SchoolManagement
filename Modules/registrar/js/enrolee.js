  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (e.target.classList.contains("view-btn")) {
        ...
        fetch(`${BASE_URL}/enrollee/${studentId}`)
    ...
    */
    ...
    fetch(`${BASE_URL}/enrollee/all?status=${status}&limit=${limit}&page=${page}&search=${encodeURIComponent(search)}`)
        .then(response => response.json())
        .then(result => {
            ...
            result.data.forEach(enrollee => {
                tbody.innerHTML += `
                    <tr class="student-row">
                            ...
                            <td>${enrollee.sex}</td>
                        <td>
                            <button class="btn btn-sm btn-primary view-btn" data-id="${enrollee.id  }">
                                View
                            </button>
                        </td>
                    </tr>
