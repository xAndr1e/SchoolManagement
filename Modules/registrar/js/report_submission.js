  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteBtn.addEventListener('click', function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`${BASE_URL}/reports-submit/delete`, {
                    method: 'POST',
    ...
    */
    ...
    submitApprove.addEventListener('click',function(){
       ...
       let submitReportModal = new bootstrap.Modal(document.getElementById('submitReportModal'));
    ...
    document.getElementById('addReportSubmit').addEventListener('click', function() {

    document.getElementById('addReportSubmitForm').requestSubmit();
   ...
   document.getElementById('addReportSubmitForm').addEventListener('submit', function(e) {
    e.preventDefault(); 
    ...
    .then(data => {
        ...
        if (data.status === 'error') {
            ...
            const submitReportModal = bootstrap.Modal.getInstance(document.getElementById('submitReportModal'));
            submitReportModal.hide();
    ...
    */
    ...
    fetch(`${BASE_URL}/reports-submit/all?order=${order}&limit=${limit}&page=${page}&search=${encodeURIComponent(search)}`)
            ...
            result.data.forEach((report)=> {
                tbody.innerHTML += `
                    <tr class="activity-row">
                     ...
                     <td><input type="checkbox" class="activity-checkbox" value="${report.report_id}"></td>
