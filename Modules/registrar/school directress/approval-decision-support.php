        ...
        <div class="approval-upload">
            ...
            <form id="approval-upload-form" enctype="multipart/form-data" data-skip>
                ...
                <div class="form-group">
                    ...
                    <textarea id="approval-description" name="description" required></textarea>
                </div>
                <div class="form-group">
                        ...
                        <?php if (!empty($approvals)) : ?>
                            <?php foreach ($approvals as $approval) : ?>
                                <tr data-approval-id="<?= htmlspecialchars($approval['approval_id']) ?>">
                                    ...
                                    <td>
                                        <div class="actions">
                                            <button class="btn-approve" data-id="<?= $approval['approval_id'] ?>">Approve</button>
                                            <button class="btn-reject" data-id="<?= $approval['approval_id'] ?>">Reject</button>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if ($approval['file_path']) : ?>
                                            <a style="color:var(--color2); text-decoration:none;" href="<?= htmlspecialchars($approval['file_path']) ?>" target="_blank">View</a>
                                        <?php else : ?>
