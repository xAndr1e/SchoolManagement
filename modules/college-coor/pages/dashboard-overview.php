...
<?php endforeach; ?>
        ...
        <!-- Activities Modal -->
        <div id="activitiesModal" class="activities-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 99999; align-items: center; justify-content: center;">
