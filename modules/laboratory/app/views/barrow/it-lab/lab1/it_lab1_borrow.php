    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#lab1AddBorrowModal">
                    <i class="fas fa-plus me-1"></i> Create New
                </button>
            </div>
            <div class="card-body">
                <table id="lab1BorrowTable" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Laboratory</th>
...
<script src="<?= BASE_URL ?>/js/lab1Borrow.js"></script>
