...
<main class="main-content">
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <h3 class="mb-1">Inactive IT Lab 2 Borrowing</h3>
        ...
        <div class="card shadow-sm border-0 border-top border-4 border-secondary">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="lab2InactiveBorrowTable"
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <!-- Activate -->
                                                <li>
                                                    <a href="<?= BASE_URL ?>/lab2-borrow/activate/<?= $row['id']; ?>"
...
<script>
    $(document).ready(function() {
        ...
        $('#lab2InactiveBorrowTable').DataTable({
            pageLength: 10,
