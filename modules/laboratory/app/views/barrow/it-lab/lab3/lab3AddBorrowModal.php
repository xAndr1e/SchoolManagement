<div class="modal fade" id="lab3AddBorrowModal" tabindex="-1" aria-labelledby="lab3AddBorrowModalLabel"
    aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <form id="lab3AddBorrowForm" action="<?= BASE_URL ?>/lab3-borrow/create" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="laboratory" class="form-control" value="IT Lab 3" readonly>
                        </div>
