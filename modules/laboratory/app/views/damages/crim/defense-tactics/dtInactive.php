...
<main class="main-content">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="mb-1">Inactive Defense Tactics Damages</h3>
            ...
            <a href="<?= BASE_URL ?>/defense-tactics-damage"
        ...
        <div class="card mb-4 shadow-sm border-0 border-top border-4 border-secondary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dtInactiveDamageTable"
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a
                                                            ...
                                                            href="<?= BASE_URL ?>/defense-tactics-damage/view/<?= $row['id']; ?>">
                                                    ...
                                                    <li>
                                                        <a
                                                            ...
                                                            href="<?= BASE_URL ?>/defense-tactics-damage/activate/<?= $row['id']; ?>"
...
<script>
    $(document).ready(function() {
        ...
        $('#dtInactiveDamageTable').DataTable({
            pageLength: 10,
