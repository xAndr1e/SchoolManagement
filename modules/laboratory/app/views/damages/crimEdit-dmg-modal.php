<div class="modal fade" id="crimEditDamageModal" tabindex="-1">
                ...
                <form id="editDamageForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="edit_item" id="item" required>
                            ...
                            <option value="">Crime Scene</option>
                            <option value="">Balistic</option>
                            <option value="">Questions Document</option>
                            <option value="">Chemistry</option>
                            <option value="">Defense and Tactics</option>
