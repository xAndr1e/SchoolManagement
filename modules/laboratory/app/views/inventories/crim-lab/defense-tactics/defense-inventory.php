...
<main class="main-content">
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <button
                        ...
                        data-bs-target="#dtAddInventoryModal">
                        <i class="fas fa-plus me-1"></i> Create New
                    </button>

                    <a href="<?= BASE_URL ?>/defense-inventory/inactive"
            ...
            <div class="card-body">
                <table id="dtEquipmentTable" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Item Name</th>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="<?= BASE_URL ?>/defense-inventory/deactivate/<?= $row['id']; ?>"
...
<script src="<?= BASE_URL ?>/js/dtInventory.js"></script>
