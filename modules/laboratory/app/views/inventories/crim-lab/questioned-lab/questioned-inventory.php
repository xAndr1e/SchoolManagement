            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <button
                        ...
                        data-bs-target="#qdAddInventoryModal">
                        <i class="fas fa-plus me-1"></i> Create New
                    </button>

                    <a href="<?= BASE_URL ?>/questioned-inventory/inactive"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="<?= BASE_URL ?>/questioned-inventory/deactivate/<?= $row['id']; ?>"
...
<script src="<?= BASE_URL ?>/js/qdInventory.js"></script>
