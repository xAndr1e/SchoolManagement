...
<main class="main-content">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="mb-1">Inactive Crime Scene Monitoring</h3>
                <p class="text-muted mb-0">
                    Monitoring records that have been deactivated.
                </p>
            </div>

            <a href="<?= BASE_URL ?>/crime-scene-monitoring"
        ...
        <div class="card mb-4 shadow-sm border-0 border-top border-4 border-secondary">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="csInactiveMonitoringTable"
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a
                                                            ...
                                                            href="<?= BASE_URL ?>/crime-scene-monitoring/activate/<?= $row['id']; ?>"
...
<script>
    $(document).ready(function() {
        ...
        $('#csInactiveMonitoringTable').DataTable({
            pageLength: 10,
