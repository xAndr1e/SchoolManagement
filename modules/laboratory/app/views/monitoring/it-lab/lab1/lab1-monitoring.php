        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?= BASE_URL ?>/lab1-monitoring/inactive"
            ...
            <div class="card-body">
                <table id="lab1EquipmentTable" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Item Name</th>
                               ...
                               <div class="dropdown">
                                    <button class="btn btn-secondary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="<?= BASE_URL ?>/lab1-monitoring/deactivate/<?= $row['id']; ?>"
...
<script src="<?= BASE_URL ?>/js/lab1Monitoring.js"></script>
