document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/balistic-borrow/view/${id}`)
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("balEditBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/balistic-borrow/view/${id}`)
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("balViewBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  window.location.href = `${BASE_URL}/balistic-borrow/delete/${id}`;
});
