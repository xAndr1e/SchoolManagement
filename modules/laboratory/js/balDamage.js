document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/balistic-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("balEditDamageModal"),
      );
  ...
  fetch(`${BASE_URL}/balistic-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("balViewDamageModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/balistic-damage/delete/${id}`;
  }
});
