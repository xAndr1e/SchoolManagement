document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/ballistic-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("balEditMonitoringModal"),
      );
  ...
  fetch(`${BASE_URL}/ballistic-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      const viewModal = new bootstrap.Modal(
        document.getElementById("balViewMonitoringModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/ballistic-monitoring/delete/${id}`;
  }
});
