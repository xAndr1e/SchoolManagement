document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/chemistry-borrow/view/${id}`)
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("chemEditBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/chemistry-borrow/view/${id}`)
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("chemViewBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  window.location.href = `${BASE_URL}/chemistry-borrow/delete/${id}`;
});
