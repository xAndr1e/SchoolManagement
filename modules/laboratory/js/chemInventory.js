document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/chemestry-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      document.getElementById("edit_available_item").value =
        data.available_item;
      document.getElementById("edit_status").value = data.status;

      let editModal = new bootstrap.Modal(
        document.getElementById("chemistryEditInventoryModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/chemestry-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      document.getElementById("view_total_quantity").value = data.total_item;
      document.getElementById("view_available_quantity").value =
        data.available_item;
      document.getElementById("view_status").value = data.status;

      let viewModal = new bootstrap.Modal(
        document.getElementById("chemistryViewInventoryModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/chemestry-inventory/delete/${id}`;
  }
});
