document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/chemistry-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("chemEditMonitoringModal"),
      );
  ...
  fetch(`${BASE_URL}/chemistry-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      const viewModal = new bootstrap.Modal(
        document.getElementById("chemViewMonitoringModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/chemistry-monitoring/delete/${id}`;
  }
});