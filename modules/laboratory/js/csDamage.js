document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/crime-scene-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("csEditDamageModal"),
      );
  ...
  fetch(`${BASE_URL}/crime-scene-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("csViewDamageModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/crime-scene-damage/delete/${id}`;
  }
});
