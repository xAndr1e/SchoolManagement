document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/crime-scene-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("csEditInventoryModal"),
      );
  ...
  fetch(`${BASE_URL}/crime-scene-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("csViewInventoryModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/crime-scene-inventory/delete/${id}`;
  }
});
