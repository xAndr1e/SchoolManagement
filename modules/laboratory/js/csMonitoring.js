document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/crime-scene-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("csEditMonitoringModal"),
      );
  ...
  fetch(`${BASE_URL}/crime-scene-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      const viewModal = new bootstrap.Modal(
        document.getElementById("csViewMonitoringModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/crime-scene-monitoring/delete/${id}`;
  }
});
