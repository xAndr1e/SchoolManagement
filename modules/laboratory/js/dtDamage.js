document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/defense-tactics-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("dtEditDamageModal"),
      );
  ...
  fetch(`${BASE_URL}/defense-tactics-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("dtViewDamageModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/defense-tactics-damage/delete/${id}`;
  }
});
