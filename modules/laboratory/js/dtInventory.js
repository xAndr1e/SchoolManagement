document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/defense-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("dtEditInventoryModal"),
      );
  ...
  fetch(`${BASE_URL}/defense-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("dtViewInventoryModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/defense-inventory/delete/${id}`;
  }
});
