document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/defense-tactics-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("dtEditMonitoringModal"),
      );
  ...
  fetch(`${BASE_URL}/defense-tactics-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      const viewModal = new bootstrap.Modal(
        document.getElementById("dtViewMonitoringModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/defense-tactics-monitoring/delete/${id}`;
  }
});
