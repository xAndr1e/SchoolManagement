document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/fingerprint-borrow/view/${id}`)
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("fpEditBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/fingerprint-borrow/view/${id}`)
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("fpViewBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  window.location.href = `${BASE_URL}/fingerprint-borrow/delete/${id}`;
});
