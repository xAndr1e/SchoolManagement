document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/fingerprint-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("fpEditInventoryModal"),
      );
  ...
  fetch(`${BASE_URL}/fingerprint-inventory/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("fpViewInventoryModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/fingerprint-inventory/delete/${id}`;
  }
});
