document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/fingerprint-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("fpEditMonitoringModal"),
      );
  ...
  fetch(`${BASE_URL}/fingerprint-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      const viewModal = new bootstrap.Modal(
        document.getElementById("fpViewMonitoringModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/fingerprint-monitoring/delete/${id}`;
  }
});
