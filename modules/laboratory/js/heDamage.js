document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/he_damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("heEditDamageModal"),
      );
  ...
  fetch(`${BASE_URL}/he_damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("heViewDamageModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/he_damage/delete/${id}`;
  }
});
