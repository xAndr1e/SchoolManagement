document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/lab1-borrow/view/${id}`)
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("lab1EditBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/lab1-borrow/view/${id}`)
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("lab1ViewBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  window.location.href = `${BASE_URL}/lab1-borrow/delete/${id}`;
});
