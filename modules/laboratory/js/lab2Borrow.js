document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/lab2-borrow/view/${id}`)
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("lab2EditBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/lab2-borrow/view/${id}`)
    ...
    .then((data) => {
      ...
      const modalElement = document.getElementById("lab2ViewBorrowModal");
...
document.addEventListener("click", function (e) {
  ...
  window.location.href = `${BASE_URL}/lab2-borrow/delete/${id}`;
});
