document.addEventListener("click", function (e) {
    ...
    fetch(`${BASE_URL}/it-lab2-inventory/view/${id}`)
        ...
        .then(data => {
            ...
            let editModal = new bootstrap.Modal(
                document.getElementById("itLab2EditInventoryModal")
            );
...
document.addEventListener("click", function (e) {
    ...
    fetch(`${BASE_URL}/it-lab2-inventory/view/${id}`)
        ...
        .then(data => {
            ...
            document.getElementById("view_available_quantity").value = data.available_item;
            document.getElementById("view_status").value = data.status;

            let viewModal = new bootstrap.Modal(
                document.getElementById("itLab2ViewInventoryModal")
            );
...
document.addEventListener("click", function (e) {
    ...
    if (confirm("Are you sure you want to delete this inventory?")) {
        ...
        window.location.href = `${BASE_URL}/it-lab2-inventory/delete/${id}`;
