document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/lab2-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("lab2EditMonitoringModal"),
      );
  ...
  fetch(`${BASE_URL}/lab2-monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      const viewModal = new bootstrap.Modal(
        document.getElementById("lab2ViewMonitoringModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/lab2-monitoring/delete/${id}`;
  }
});
