document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/lab3-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("lab3EditDamageModal"),
      );
  ...
  fetch(`${BASE_URL}/lab3-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("lab3ViewDamageModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/lab3-damage/delete/${id}`;
  }
});
