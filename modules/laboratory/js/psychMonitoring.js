document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/psy_monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("psyEditMonitoringModal"),
      );
  ...
  fetch(`${BASE_URL}/psy_monitoring/view/${id}`)
    ...
    .then((data) => {
      ...
      const viewModal = new bootstrap.Modal(
        document.getElementById("psyViewMonitoringModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/psy_monitoring/delete/${id}`;
  }
});
