document.addEventListener("click", function (e) {
  ...
  fetch(`${BASE_URL}/question-document-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let editModal = new bootstrap.Modal(
        document.getElementById("qdEditDamageModal"),
      );
  ...
  fetch(`${BASE_URL}/question-document-damage/view/${id}`)
    ...
    .then((data) => {
      ...
      let viewModal = new bootstrap.Modal(
        document.getElementById("qdViewDamageModal"),
      );
...
document.addEventListener("click", function (e) {
  ...
  if (confirm("Are you sure you want to delete this inventory?")) {
    window.location.href = `${BASE_URL}/question-document-damage/delete/${id}`;
  }
});
