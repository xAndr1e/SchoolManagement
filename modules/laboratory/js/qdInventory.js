document.addEventListener("click", function (e) {
    ...
    fetch(`${BASE_URL}/questioned-inventory/view/${id}`)
        ...
        .then(data => {
            ...
            let editModal = new bootstrap.Modal(
                document.getElementById("qdEditInventoryModal")
            );
    ...
    fetch(`${BASE_URL}/questioned-inventory/view/${id}`)
        ...
        .then(data => {
            ...
            let viewModal = new bootstrap.Modal(
                document.getElementById("qdViewInventoryModal")
            );
...
document.addEventListener("click", function (e) {
    ...
    if (confirm("Are you sure you want to delete this inventory?")) {
        ...
        window.location.href = `${BASE_URL}/questioned-inventory/delete/${id}`;
