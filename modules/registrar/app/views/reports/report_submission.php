...
<main class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div id="dashboard-title">
            <h1 class="h3 fw-bold mb-0">Report Submissions & Management</h1>
             <p class="text-muted small">View and manage submitted reports from teachers and staff.</p>
        </div>

          <button class="btn btn-primary btn-sm" id="submitApprove">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <h3 class="fs-6 mb-0 text-primary">Report List</h3>
...
<div class="modal fade" id="submitReportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content shadow-sm">
            ...
            <div class="modal-body">
                ...
                <form class="row g-3" id="addReportSubmitForm" action="<?php echo BASE_URL ?>/reports-submit/store" method="POST" enctype="multipart/form-data">
...
<script src="<?php echo BASE_URL ?>/js/report_submission.js"></script>
