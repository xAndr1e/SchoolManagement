...
<main class="main-content">
    <div class="container">
        ...
        <div id="dashboard-title">
            <h1 class="h3 fw-bold mb-0">Examinations Days</h1>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div>
                    ...
                    <small class="text-muted" id="modalExamDate"></small>
                </div>
            ...
            <div class="modal-body">
                ...
                <div id="sectionLoading" class="text-center py-4">
                    <div class="spinner-border"></div>
                    <p class="mt-2 mb-0">Loading sections...</p>
                </div>

                <div id="sectionList" class="row g-3 d-none">
                </div>
...
<script src="<?php echo BASE_URL ?>/js/examinations.js"></script>
