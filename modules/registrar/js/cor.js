  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    */
    ...
    function getCor(studentId)
    {

          window.open(
        `${BASE_URL}/COR/${studentId}/pdf`,
        "_blank"
        );
                ...
                tbody.innerHTML += `
                    <tr class="student-row">
                        ...
                        <td>
                            ...
                            <button class="btn btn-sm btn-success view-btn" data-id="${student.student_id}" onclick="getCor(${student.student_id})">
                                Generate COR
                            </button>

                             <a href="${BASE_URL}/students/show/${student.student_id}"
